...
mnemonic = a.FromWordsNumber(words_num=int(input("please enter number of mnemonic words you want 12 or 24?")))
...
for i in range(int(input("please enter number of wallets that you need:"))):
    bip_obj_addr = bip_obj_chain.AddressIndex(i)
    print(f"{i+1}. Address private key:\n{bip_obj_addr.PrivateKey().Raw()}")
